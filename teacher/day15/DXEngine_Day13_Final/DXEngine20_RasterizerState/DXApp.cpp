...
DXApp::DXApp(HINSTANCE hinstance)
{
	...
	clientWidth = 1600;
	clientHeight = 960;
	applicationName = L"Engine20 - Rasterizer State";
...
bool DXApp::InitScene()
{
	...
	// 래스터라이저 스테이트 생성.
	if (!mesh->CreateRasterizerState(pDevice, D3D11_FILL_SOLID, D3D11_CULL_NONE))
		return false;
...
void DXApp::InitMeshInfo()
{
	...
	//skySphere.SetPosition(XMFLOAT3(-300.0f, 0.0f, 0.0f));
	skySphere.SetScale(XMFLOAT3(10.0f, 10.0f, 10.0f));
	//meshes.push_back(sphere);

	Mesh cube(fbxNameCube, L"Shaders//CubeVS.fx", L"Shaders//CubePS.fx");
	cube.AddTexture(cubeMap);
