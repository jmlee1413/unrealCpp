...
DXApp::DXApp(HINSTANCE hinstance)
{
	...
	clientWidth = 800;
	clientHeight = 600;
	applicationName = L"Engine05 - WorldViewProjection";
...
bool DXApp::InitScene()
{
	...
	HRESULT hr;
	hr = D3DX11CompileFromFile(L"EffectVS.fx", NULL, NULL, "main",
	...
	hr = D3DX11CompileFromFile(L"EffectPS.fx", NULL, NULL, "main",
	...
	vbDesc.ByteWidth = sizeof(D3D11_BUFFER_DESC) * ARRAYSIZE(vertices);
...
bool DXApp::InitTransformation()
{
	...
	cameraPos    = XMVectorSet(1.f, 1.f, -2.f, 0.f);
